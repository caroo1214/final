...
botonCarrito.addEventListener('click',vaciarCarrito);

function vaciarCarrito() {
  cart = []; // Eliminar todos los elementos del carrito
  total = 0; // Restar el total
  renderCart(); // Volver a renderizar el carrito para actualizar la vista
  cargarProducts(); // Volver a cargar los productos para actualizar el stock
}